...
public class CSVFileHandler implements MyFileHandler{
    public void read() {
        ...
        try {
            scanner = new Scanner(new File("/Users/dhruvbatta/IdeaProjects/Project1/src/employee.csv"));
    ...
    public void write(){
        File file = new File("/Users/dhruvbatta/IdeaProjects/Project1/src/GENemployee.csv");
        try {
