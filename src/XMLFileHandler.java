...
public class XMLFileHandler implements MyFileHandler{
    public void read(){
        try {
            File xmlFile = new File("/Users/dhruvbatta/IdeaProjects/Project1/src/employee.xml");
    ...
    public void write(){
        try {
            ...
            StreamResult streamResult = new StreamResult(new File("/Users/dhruvbatta/IdeaProjects/Project1/src/GENemployee.xml"));
