...
public class JSONFileHandler implements MyFileHandler{
    ...
    public void write(){
        try {
            FileWriter file = new FileWriter("/Users/dhruvbatta/IdeaProjects/Project1/src/GENemployee.json");
    ...
    public void read()
    {
        ...
        try (FileReader reader = new FileReader("/Users/dhruvbatta/IdeaProjects/Project1/src/employee.json"))
        {
            //Read JSON file
